    ...
    <article class="flex flex-col w-full">
          ...
          <aside id="library-quick-access" class="flex flex-col space-y-4">
            <div class="p-4 bg-indigo-100 rounded-lg shadow-lg">
              ...
              <div>
                ...
                <div class="px-4">
                  <p>
                    Pondělí: <span>9.30-11.00</span>, <span>12.00-18.00</span>
                  </p>
          ...
          <div class="relative">
            <div class="flex flex-col justify-center space-x-4 sm:flex-row">
              <div
                ...
                :key="edge.node.id"
                class="relative items-center flex-grow block w-full p-4 overflow-hidden bg-white rounded-t-lg shadow-lg md:w-2/5 rounded-2xl"
            ...
            <button
              class="absolute top-0 left-0 w-12 h-12 mt-32 -ml-6 text-2xl text-indigo-600 bg-white rounded-full shadow-md hover:text-indigo-400 focus:text-indigo-400 focus:outline-none focus:shadow-outline"
              >
            <span class="block" style="transform: scale(-1)">&#x279c;</span>
            </button>
            <button
              class="absolute top-0 right-0 w-12 h-12 mt-32 -mr-6 text-2xl text-indigo-600 bg-white rounded-full shadow-md hover:text-indigo-400 focus:text-indigo-400 focus:outline-none focus:shadow-outline"
              >
            <span class="block" style="transform: scale(1)">&#x279c;</span>
            </button>
          </div>
      ...
      <section id="projects" class="bg-coal-100 sm:px-4">
        <div class="p-4 md:p-8 lg:p-16">
          <h1 class="pb-4 text-2xl font-black text-center lg:pb-16">
            Projekty
          </h1>
          <ul class="flex flex-col justify-center w-full space-y-2 sm:space-x-4 sm:space-y-0 sm:flex-row">
            <li
              v-for="edge in $static.projects.edges"
              :key="edge.node.id"
              class="block p-4 bg-white rounded shadow-sm">
      ...
      <section id="library" class="bg-paralex-library">
        <div class="p-4 md:p-8">
          ...
          <h2 class="pb-4 text-sm font-semibold text-center text-indigo-50">
            Přehled zajímavých čísel z místní knihovny
          </h2>
          <div
            class="flex flex-col flex-wrap justify-center p-2 space-y-2 sm:flex-nowrap sm:space-y-0 sm:space-x-2 sm: lg:space-x-8 sm:flex-row"
            >
            <div
              v-for="edge in $page.statistics.edges"
              :key="edge.node.model"
              class="flex flex-row w-full p-2 duration-150 ease-in-out transform bg-white border rounded shadow-sm motion-reduce:transform-none h-max sm:flex-col hover:-translate-y-2 hover:shadow-md"
              >
              <g-image
                :src="assets_image(edge.node.model)"
                alt=""
                aria-hidden="true"
                width="2em"
                height="2em"
                class="sm:mx-auto h-36 w-36"
                />
      ...
      <section id="contact" class="py-4">
        <div class="p-4 md:p-8">
          ...
          <div class="flex flex-col justify-center sm:flex-row sm:space-x-2">
            <div class="p-4 shadow-sm">Sociální sítě</div>
...
<page-query>
  query Events {
    ...
    prismicio {
      events: allEvents(sortBy: meta_lastPublicationDate_DESC, first: 4) {
        edges {
          node {
            title
            short
