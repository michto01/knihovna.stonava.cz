<template>
    <div v-if="!isHidden" class="transition duration-500 ease-out bg-indigo-600">
        <div class="px-3 py-3 mx-auto max-w-7xl sm:px-6 lg:px-8">
            ...
            <div class="flex items-center flex-1 w-0">
                ...
                <p class="ml-3 font-medium text-white truncate">
                    ...
                    <span class="hidden md:inline">
                        Změny otevírací doby, pravidla výpujčky a další.
                    </span>
                </p>
            </div>
            ...
            <div class="flex-shrink-0 order-2 sm:order-3 sm:ml-3">
                <button type="button" v-on:click="isHidden = !isHidden" class="flex p-2 -mr-1 rounded-md hover:bg-indigo-500 focus:outline-none focus:ring-2 focus:ring-white sm:-mr-2">
